...
import vicand.finaleda.ModelViews.IndexViewController;
import vicand.finaleda.ModelViews.SearchViewController;
...
public class MainWindow {
	...
	private DefaultTableModel tableD = new DefaultTableModel(tableData,
			new String[] { "Nombre", "Tipo", "Ruta de archivo" });
	...
	private void initialize() {
		...
		frmProyectoFinalEda
				.setIconImage(Toolkit.getDefaultToolkit().getImage(MainWindow.class.getResource("/resources/seo.png")));
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addContainerGap()
						.addComponent(tabbedPane, GroupLayout.DEFAULT_SIZE, 528, Short.MAX_VALUE).addContainerGap()));
		...
		btnIndexar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				indexViewController.IndexFolderContents(txtIndexar.getText());
			}
		});
		...
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup().addGap(200)
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ArrayList<String[]> data = searchViewController.Search(textField.getText());
				int num = data.size();
				String[][] _table = new String[num][3];
				for (int i = 0; i < num; i++) {
					_table[i][0] = data.get(i)[0];
					_table[i][1] = data.get(i)[1];
					_table[i][2] = data.get(i)[2];
				}
				table.setModel(new DefaultTableModel(_table, new String[] { "Nombre", "Tipo", "Ruta de archivo" }));
			}
		});
		...
		gl_panel_1.setHorizontalGroup(gl_panel_1.createParallelGroup(Alignment.LEADING).addGroup(Alignment.TRAILING,
				gl_panel_1.createSequentialGroup().addContainerGap(67, Short.MAX_VALUE).addGroup(gl_panel_1
